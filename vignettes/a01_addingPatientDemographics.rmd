...
When performing analyses we will often be interested in working with the person and observation period tables to identify individuals' characteristics on some date of interest. CohortCharacteristics provides a number of functions that can help us do this.
...
As well as age at diagnosis, we might also want identify patients' sex. CohortCharacteristics provides the `addSex()` function that will add this for us. Because this is treated as time-invariant, we will not have to specify any index variable.
